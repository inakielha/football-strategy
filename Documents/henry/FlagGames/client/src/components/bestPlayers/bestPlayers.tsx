...
import style from "./bestPlayer.module.css"
import Nav from "../navbar/navbar"

export default function BestPlayers():JSX.Element{
    ...
    useEffect(()=>{
    dispatch(GET_TOP_TEN_RANKED_PLAYERS("flags"))
    },[])
    return (
        <div className={style.container}>
            ...
            <h2 className={style.h2}>Best Top <span className={style.span}>10</span>Flags Players</h2>
